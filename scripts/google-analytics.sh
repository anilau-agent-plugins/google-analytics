...
printf '%s\n' '{"schemaVersion":1,"cliVersion":"0.5.0","ok":false,"command":"bootstrap","status":"error","data":{},"warnings":[],"errors":[{"code":"PYTHON_RUNTIME_UNAVAILABLE","message":"Supported CPython 3.10-3.13 was not found.","retryable":false,"details":{},"nextAction":"Install a standard 64-bit CPython from https://www.python.org/downloads/ after explicit consent, then run again."}]}'
exit 2
