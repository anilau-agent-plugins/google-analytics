...
Google Analytics Advisor 0.10.2 runs locally in the user's environment. It does not collect telemetry
...
identity, GA4 read/edit and GTM read/edit/version/publish. Version 0.10.2 can perform allowlisted GA4
...
as ambiguous and is not retried automatically. Version 0.9.0 can send only an event bound to a
