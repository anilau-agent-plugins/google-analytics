...
[![Version 0.10.2](https://img.shields.io/badge/version-0.10.2-2563eb)](https://github.com/anilau-agent-plugins/google-analytics/releases/latest)
...
2. Download the file named `google-analytics-0.10.2.zip` and unpack it.
...
version 0.10.2; this prevents an unverified file from silently changing installed code. The plugin can
